...
namespace rocognitionofhumanbyretina.DatabaseDataSetTableAdapters {
    ...
    public partial class testTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [test] WHERE (([id] = @p1))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [test] ([id], [name]) VALUES (@p1, @p2)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [test] SET [id] = @p1, [name] = @p2 WHERE (([id] = @p3))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::rocognitionofhumanbyretina.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [id], [name] FROM [test]";
        ...
        public virtual int Fill(DatabaseDataSet.testDataTable dataTable) {
        ...
        public virtual DatabaseDataSet.testDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet.testDataTable dataTable = new DatabaseDataSet.testDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet.testDataTable dataTable) {
